...
Foundation documentation and the first CLI MVP have been initialized.

## Completed

- Required project context document created.
- Repository-level `AGENTS.md` created.
- Project `README.md` created.
- Product overview document created.
- System architecture document created.
- Coding style rules created.
- Initial agent role documents created.
- Generation workflow document created.
- Project brief and task templates created.
...
- NPM packaging and `npx` distribution.
